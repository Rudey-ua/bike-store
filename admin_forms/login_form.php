      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <form action="../admin_operation/user_operations/login.php" method="POST">
                ...
                <button style="background-color:#198754;border-color:#198754;width:300px;" class="btn btn-primary btn-lg btn-block" type="submit">Войти</button>
